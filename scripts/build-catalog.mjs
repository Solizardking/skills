...
const SITE_URL =
  process.env.SKILLHUB_SITE_URL ||
  process.env.SKILLS_URL ||
  "https://skills.x402agent.io";
const HUB_PORTAL_URL =
  process.env.HUB_URL ||
  process.env.X402_HUB_URL ||
...
function renderHub(catalog) {
  ...
  const lines = [
    ...
    "",
    "```bash",
    "npx skills add Solizardking/skillhub",
    ...
    "",
    "```bash",
    "npx github:Solizardking/skillhub install engineering/tdd engineering/implement engineering/triage engineering/codebase-design engineering/to-spec --force",
    "npx github:Solizardking/skillhub install agent-orchestration/goal-loop agent-orchestration/handoff agent-orchestration/codex-subagent agent-orchestration/run-deep-swe",
    "npx github:Solizardking/skillhub install productivity/grill-me productivity/teach productivity/writing-great-skills thinking-and-docs/brain-to-docs thinking-and-docs/prompt-me",
    "npx github:Solizardking/skillhub install apple-design emil-design-eng animation-vocabulary review-animations",
    "npx github:Solizardking/skillhub install research-and-web/deep-research research-and-web/browser-harness skill-authoring/effective-agent-skills ops-and-setup/setup-help",
    "npx github:Solizardking/skillhub install misc/setup-pre-commit in-progress/wizard personal/obsidian-vault deprecated/qa",
    "```",
    "",
    "Also available — NVIDIA / Solana / Google stacks:",
    "",
    "```bash",
    "npx github:Solizardking/skillhub install nvidia/jetson-quick-start nvidia/deepstream-dev nvidia/cudaq-guide nvidia/aiq-deploy nvidia/cuopt-developer --force",
    "npx github:Solizardking/skillhub install solana-dev solana-formal-verification magicblock --force",
    "npx github:Solizardking/skillhub install pumpfun pump-token-lifecycle pump-bonding-curve pump-fee-sharing pump-claims-readonly pump-security",
    "npx github:Solizardking/skillhub install ask-mcp compressed-pda compressed-token solana-redpill-verifier solana-rent-free-dev testing zk zkrouter",
    "npx github:Solizardking/skillhub install google/cloud/gke-basics google/cloud/gcloud google/cloud/bigquery-basics",
    "npx github:Solizardking/skillhub install google/ads/google-ads-api/google-ads-api-quickstart google/analytics/google-analytics-data-api-basics",
    "```",
    "",
...
function renderSiteManifest(catalog, registry) {
  return {
    ...
    skillsSh: {
      install: "npx skills add Solizardking/skillhub",
...
<body>
  <main class="shell">
    ...
    <section aria-label="Skill catalog">
      <div class="section-head">
        <h2>All Skills</h2>
        <span>Install all: <code>npx github:Solizardking/skillhub install</code></span>
      </div>
    </section>
  ...
  <script>
    ...
    function renderCreatorPlan() {
      ...
      creatorOutput.value = [
        ...
        "",
        "Install creator:",
        "npx github:Solizardking/skillhub install skill-creator",
        "",
    ...
    function installCommand(slug) {
      return \`npx github:Solizardking/skillhub install \${slug}\`;
    }
